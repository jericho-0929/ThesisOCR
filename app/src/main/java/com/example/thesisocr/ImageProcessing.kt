...
class ImageProcessing {
    ...
    fun invertImage(inputMat: Bitmap): Bitmap {
        val invertedMat = Mat()
        Utils.bitmapToMat(inputMat, invertedMat)
        Core.bitwise_not(invertedMat, invertedMat)
        return convertToBitmap(invertedMat)
    }
